...
**Ядро не питає, де що лежить — йому кажуть.** Теку конфігурації NVDA знає `config`, шлях до чекліста знає файловий діалог; у `core` приходить готовий шлях, а не спосіб його дізнатися. Інакше перший же `import globalVars` зніме все сказане вище.
