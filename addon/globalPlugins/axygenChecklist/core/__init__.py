...
core is free of NVDA, and no separate check is needed — except for `wx`,
which the development environment does hold for the sake of the type check,
and which tests/unit/test_boundary.py therefore watches by hand. The section
on the core/shell boundary in docs/development.md says what falls on each
side.
